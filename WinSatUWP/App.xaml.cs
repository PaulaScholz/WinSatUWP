...
// The ConnectionReadyMessage used by MVVMLight.Messaging
using WinSatUWP.Messages;

// used to notify the MainPage that we've received a connection from WinSatInfo (Win32 app)
    ...
    sealed partial class App : Application
    {
        ...
        protected override void OnBackgroundActivated(BackgroundActivatedEventArgs args)
        {
            ...
            if (args.TaskInstance.TriggerDetails is AppServiceTriggerDetails)
            {
                ...
                // Inform the MainPage so it can hook up the Connection event handlers
                // to its methods.   MainPage holds the only Messenger subscriber.
